...
REM
REM Generated by Vivado on Sat Jan 03 19:14:46 -0800 2026
...
echo "xvhdl --incr --relax -prj BTNS_to_LEDS_vhdl.prj"
call xvhdl  --incr --relax -prj BTNS_to_LEDS_vhdl.prj -log xvhdl.log
